...
- ☎️ Former **Customer Service Associate** at Tech Mahindra
- 📊 Building an end-to-end Data Analytics, Machine Learning & AI portfolio
...
| 📦 **[Retail Inventory Forecast Dashboard](https://github.com/JEISAMATHEW/Retail-inventory-forecast-dashboard)** | Cleaned and validated a 76,000-row, 5-store × 20-SKU retail dataset in Excel Power Query, then built forecast and inventory-risk calculated fields in Tableau, shipping a two-tab dashboard that flags stockout/overstock risk and recommends reorder, transfer, or hold actions |
...
| Project | Description |
|---|---|
| 🫁 **COVID-19 Detection using CNN** | Deep learning model to classify chest X-rays using Convolutional Neural Networks |
| 🖼 **Image Recognition & Classification** | ML-based image classification system |
| 🏥 **Hospital Database Management System** | Relational database system for managing hospital records |
| 📱 **Android File Management Application** | Mobile app for organizing and managing device files |
...
- 💻 **GitHub:** [github.com/JEISAMATHEW](https://github.com/JEISAMATHEW)
- 🌐 **Portfolio:** [jeisamathew.github.io](https://jeisamathew.github.io/)
...
*"Turning Data into Decisions, Analytics into Insights, and AI into Impact."*
